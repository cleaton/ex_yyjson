defmodule Bench do
  ...
  def run_decode do
    Benchee.run(decode_jobs(),
      ...
      formatters: [
        {Console, extended_statistics: false},
        {HTML, extended_statistics: false, file: Path.expand("output/decode.html", __DIR__)}
      ]
    )
  end
